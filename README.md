...
## The "google_closure_compiler" task

### Overview
In your project's Gruntfile, add a section named `google_closure_compiler` to the data object passed into `grunt.initConfig()`.
